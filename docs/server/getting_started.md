...
3. Configure a zero-scaling Radix trigger for `acidwatch.<model_id>`.
...
RabbitMQ declares queues automatically during local startup. Azure Service Bus
queues must exist before deployment.
