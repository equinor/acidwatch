    ...
    for res in list(results):
        try:
            ...
            if "results" in raw_data and "initfinaldiff" in raw_data["results"]:
                ...
                res["initial_concentrations"] = initfinaldiff.get("initial", {})
                res["final_concentrations"] = initfinaldiff.get("final", {})
                res["panels"] = raw_data.get("analysis", {})
            else:
                # new incorrect format
                res["initial_concentrations"] = raw_data.get(
                    "initialConcentrations", {}
                )
                res["final_concentrations"] = raw_data.get("finalConcentrations", {})
